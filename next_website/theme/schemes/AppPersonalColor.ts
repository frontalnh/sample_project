...
export const AppColors = {
  primary: '#60FFB6',
  primary80: alpha('#60FFB6', 0.8),
  primary60: alpha('#60FFB6', 0.6),
  primary40: alpha('#60FFB6', 0.4),
  primary20: alpha('#60FFB6', 0.2),
  secondary: '#60E2FF',
  secondary80: alpha('#60E2FF', 0.8),
  secondary60: alpha('#60E2FF', 0.6),
  secondary40: alpha('#60E2FF', 0.4),
  secondary20: alpha('#60E2FF', 0.2),
  success: '#15EF00',
  successBg: alpha('#15EF00', 0.08),
  warning: '#FFFB8E',
  warningBg: alpha('#FFFB8E', 0.08),
  error: '#FF7171',
  errorBg: alpha('#FF7171', 0.08),
  notification: '#FF4D4D',
  notificationBg: alpha('#FF4D4D', 0.08),

  info: '#33C2FF',
  black: '#202020',
  black72: alpha('#202020', 0.72),
  black60: alpha('#202020', 0.6),
  black40: alpha('#202020', 0.4),
  black10: alpha('#202020', 0.1),
  black6: alpha('#202020', 0.06),
  black4: alpha('#202020', 0.04),
  black1: alpha('#202020', 0.01),
  blueGrey: '#556372',
  darkGrey: '#7a7a7a',
  deepGrey: '#9b9b9b',
  grey: '#d2d2d2',
...
const colors = {
  ...
  layout: {
    ...
    sidebar: {
      ...
      menuItemColorActive: AppColors.primary,
      menuItemBg: AppColors.white,
      menuItemBgActive: '#f2f5f9',
      menuItemIconColor: lighten(AppColors.secondary, 0.3),
      menuItemIconColorActive: AppColors.primary,
      menuItemHeadingColor: darken(AppColors.secondary, 0.3),
    },
  },
  alpha: {
    white: {
      5: alpha(AppColors.white, 0.02),
      10: alpha(AppColors.white, 0.1),
      30: alpha(AppColors.white, 0.3),
      50: alpha(AppColors.white, 0.5),
      70: alpha(AppColors.white, 0.7),
      100: AppColors.white,
    },
    trueWhite: {
      5: alpha(AppColors.white, 0.02),
    ...
    black: {
      5: alpha(AppColors.black, 0.02),
      10: alpha(AppColors.black, 0.1),
      30: alpha(AppColors.black, 0.3),
      50: alpha(AppColors.black, 0.5),
      70: alpha(AppColors.black, 0.7),
      100: AppColors.black,
    },
  },
  secondary: {
    lighter: lighten(AppColors.secondary, 0.85),
    light: lighten(AppColors.secondary, 0.25),
    main: AppColors.secondary,
    dark: darken(AppColors.secondary, 0.2),
  },
  primary: {
    lighter: lighten(AppColors.primary, 0.85),
    light: lighten(AppColors.primary, 0.3),
    main: AppColors.primary,
    dark: darken(AppColors.primary, 0.2),
  },
  success: {
    lighter: lighten(AppColors.success, 0.85),
    light: lighten(AppColors.success, 0.3),
    main: AppColors.success,
    dark: darken(AppColors.success, 0.2),
  },
  warning: {
    lighter: lighten(AppColors.warning, 0.85),
    light: lighten(AppColors.warning, 0.3),
    main: AppColors.warning,
    dark: darken(AppColors.warning, 0.2),
  },
  error: {
    lighter: lighten(AppColors.error, 0.85),
    light: lighten(AppColors.error, 0.3),
    main: AppColors.error,
    dark: darken(AppColors.error, 0.2),
  },
  info: {
    lighter: lighten(AppColors.info, 0.85),
    light: lighten(AppColors.info, 0.3),
    main: AppColors.info,
    dark: darken(AppColors.info, 0.2),
  },
};

export const AppPersonalColor = createTheme({
  // direction: i18n.dir(),
  colors: {
    gradients: {
    ...
    secondary: {
      lighter: alpha(AppColors.secondary, 0.1),
      light: lighten(AppColors.secondary, 0.3),
      main: AppColors.secondary,
      dark: darken(AppColors.secondary, 0.2),
    },
    primary: {
      lighter: alpha(AppColors.primary, 0.1),
      light: lighten(AppColors.primary, 0.3),
      main: AppColors.primary,
      dark: darken(AppColors.primary, 0.2),
    },
    success: {
      lighter: alpha(AppColors.success, 0.1),
      light: lighten(AppColors.success, 0.3),
      main: AppColors.success,
      dark: darken(AppColors.success, 0.2),
    },
    warning: {
      lighter: alpha(AppColors.warning, 0.1),
      light: lighten(AppColors.warning, 0.3),
      main: AppColors.warning,
      dark: darken(AppColors.warning, 0.2),
    },
    error: {
      lighter: alpha(AppColors.error, 0.1),
      light: lighten(AppColors.error, 0.3),
      main: AppColors.error,
      dark: darken(AppColors.error, 0.2),
    },
    info: {
      lighter: alpha(AppColors.info, 0.1),
      light: lighten(AppColors.info, 0.3),
      main: AppColors.info,
      dark: darken(AppColors.info, 0.2),
    },
  ...
  components: {
    MuiBackdrop: {
      styleOverrides: {
        root: {
          backgroundColor: alpha(darken(AppColors.primaryAlt, 0.4), 0.2),
    ...
    MuiTabs: {
      styleOverrides: {
        ...
        indicator: {
          ...
          minHeight: 2,
          borderRadius: 0,
          border: '1px solid ' + colors.alpha.black,
          boxShadow: 'none',
        },
        scrollableX: {
